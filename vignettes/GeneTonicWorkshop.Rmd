...
```{r eda-alma}
dds_alma <- readRDS("../inst/extdata/usecase_dds_alma.rds")
dds_alma

rld_alma <- rlogTransformation(dds_alma)

anno_df <- readRDS("../inst/extdata/usecase_annodf_alma.rds")
...
```{r}
gtl_alma <- readRDS("../inst/extdata/gtl_alma.rds")
```
...
library("DEFormats")
library("edgeR")
dge_alma <- as.DGEList(readRDS("../inst/extdata/usecase_dds_alma.rds"))
```
